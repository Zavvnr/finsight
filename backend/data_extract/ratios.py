...
def compute_ratios(income: dict, balance: dict, cash_flow: dict) -> dict:
    try:
        ...
        if (current_assets and current_liabilities != 0) and current_liabilities != 0:
